    ...
    <script>
        ...
        function loadQuestion() {
            ...
            question.options.forEach((option, index) => {
                ...
                button.innerHTML =
                    `<span class="w-10 h-10 flex items-center justify-center text-white font-bold rounded-full border-2 border-gray-400">${String.fromCharCode(65 + index)}</span><span>${option.text}</span>`;
        ...
        window.onload = function() {
            loadQuestion();
            timerInterval = setInterval(updateTimer, 100); // Inicia o timer com intervalo de 100ms
        };
    </script>
</x-app-layout>
