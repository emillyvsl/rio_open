    ...
    public function run(): void
    {
        $perguntasRespostas = [
            [
                ...
                'dicas' => 'Pense no que é essencial para a fabricação de qualquer tipo de queijo.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este tipo de leite é o mais comum na produção de queijos.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este país é famoso por sua culinária e queijos.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é frequentemente associado a cenários de desenhos animados.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é conhecido por sua textura cremosa e sabor rico.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este tipo de queijo é conhecido por suas veias azuis.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é frequentemente servido em festas e eventos.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este país é conhecido por sua rica história e culinária mediterrânea.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é frequentemente usado em sanduíches e lanches.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é conhecido por seu sabor intenso e aroma característico.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é macio e cremoso, ideal para sobremesas.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo é conhecido por seu sabor forte e aroma característico.',
                'respostas' => [
            ...
            [
                ...
                'dicas' => 'Este queijo também tem uma casca branca e macia.',
                'respostas' => [
                    ['alternativa' => 'Brie', 'is_correta' => true],
                    ['alternativa' => 'Gorgonzola', 'is_correta' => false],
                    ['alternativa' => 'Provolone', 'is_correta' => false],
        ...
        foreach ($perguntasRespostas as $item) {
            $perguntaId = DB::table('perguntas')->insertGetId([
                ...
                'dicas' => $item['dicas'], // Adicionando o campo de dicas
            ]);
